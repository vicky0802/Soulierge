...
public class StorageUtils {
    ...
    public static String createExternalDirectory() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            File baseDirFile = CoreApp.INSTANCE.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
            if (baseDirFile != null) {
                baseDir = baseDirFile.getAbsolutePath();
            }
        }
        if (baseDir == null) {
            baseDir = CoreApp.INSTANCE.getFilesDir().getAbsolutePath();
        }
        return baseDir;
    }

    public static String createInternalDirectory() {
        return CoreApp.INSTANCE.getFilesDir().getAbsolutePath();
    }
